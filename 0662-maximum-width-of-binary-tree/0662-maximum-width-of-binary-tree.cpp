...
class Solution {
public:
    //BFS solution I hate bfs normally
    // basically we'll number the tree like a binary heap and in every level we check the max width b/w two nodes of same level
